...
import { fetchRoomData, remoteRoomCall } from "../services";
...
export class RoomInspect extends React.Component<Props, State> {
  ...
  sendMessage(sessionId?: string) {
    const sendToClient = sessionId ? sessionId : undefined;
  ...
  disconnectClient(sessionId: string) {
     ...
     */
    this.roomCall("_forceClientDisconnect", sessionId).then(() =>
      this.fetchRoomData(),
    );
  }

  disposeRoom() {
    this.roomCall("disconnect").then(() => {
          ...
          return (
            <>
              <Button
                variant="text"
                startIcon={<SendIcon />}
                onClick={this.sendMessage.bind(this, param.id)}
              >
                Send
              </Button>
              <Button
                ...
                onClick={this.disconnectClient.bind(this, param.id)}
              >
                Disconnect
              </Button>
            </>
              ...
              <TableRow>
                ...
                <TableCell align={"center"}>
                  ...
                  <Chip
                    ...
                    size="small"
                    color="primary"
                    label={`${this.state.clients.length}${this.state.maxClients ? " / " + this.state.maxClients : ""}`}
                  />
                </TableCell>
                ...
                <TableCell align={"center"}>
                  ...
                  <Chip
                    ...
                    size="small"
                    color="primary"
                    label={`${this.state.stateSize} bytes`}
                  />
                </TableCell>
        ...
        >
          ...
          <DialogContent>
            ...
            <JsonEditor
              ...
              propagateChanges={this.updateSendData}
            />
          </DialogContent>
          <DialogActions>
            <Button variant="text" color="error" onClick={this.handleCloseSend}>
              Cancel
            </Button>
            <Button variant="text" onClick={this.handleSend}>
              Send
            </Button>
          </DialogActions>
        </Dialog>
